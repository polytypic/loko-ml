...
**NOTE: This library is still Work-In-Progress. I plan to refine the API and
possibly rename many combinators.**
...
operation. `L.as_removed value` signals removal when the element written through
