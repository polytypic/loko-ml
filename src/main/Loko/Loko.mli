...
val partial_iso :
  ('S -> 'F option) -> ('G -> 'T option) -> ('S, 'F, 'G, 'T) optic
(** Defines a new invertible partial isomorphism from a pair of partial
    conversions. *)
...
{[
  ...
  val to_list : ('F t, 'F list, 'G list, 'G t) optic
  (** Isomorphism between arrays and lists. *)

  val to_option : ('F t, 'F option, 'G option, 'G t) optic
...
{[
  ...
  val to_array : ('F t, 'F array, 'G array, 'G t) optic
