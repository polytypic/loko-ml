...
let traversal (Iterator {start; next}) (Builder {empty; add; finish}) : _ optic
    =
 fun (_, p) ->
  ( Fwd,
    fun c xs ->
...
let cross f1 f2 (v1, v2) = (f1 v1, f2 v2)
